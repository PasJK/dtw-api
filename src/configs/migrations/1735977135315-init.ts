...
export class Init1735977135315 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            'INSERT INTO "configurations" ("refresh_token_expired_time", "access_token_expired_time", "common_link_expired_time", "invite_link_expired_time", "forgot_password_link_expired_time", "client_inactivity_time") VALUES (\'7d\', \'12h\', \'7d\', \'7d\', \'7d\', 1800000)',
        );
    }
